...
APIsql.sqlWeb.init("https://devweb.iutmetz.univ-lorraine.fr/~raitchko1u/IHM-SAE-FINAL/SAE/site/vue/", "https://devweb.iutmetz.univ-lorraine.fr/~raitchko1u/IHM-SAE-FINAL/API/");
class Connexion {
    constructor() {
        this.init();
    }
    init() {
        ...
        // APIsql.sqlWeb.bdOpen('localhost','3306','raitchko1u_ihm','pc','pc', 'utf8')
